...
Future<List<Order>> searchWith_buyPrice(double buyPrice) async {List tmp=await db.query('Order',where:"buyPrice=$buyPrice");return tmp.map((value)=>Order.fromJson(value)).toList();
}
